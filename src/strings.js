	...
	constructor(reader) {
		...
		this.values = {
			en: {
				...
				"toolbar/flow/paginated": "Page Turn: Paginated",
				"toolbar/flow/scrolled": "Page Turn: Vertical Scrolled",
				"toolbar/spread/none": "Left/Right Turn: Single Page",
				"toolbar/spread/auto": "Left/Right Turn: Double Page",
				"toolbar/search": "Search in the book",
				...
				"sidebar/search": "Search in the book",
				"sidebar/search/placeholder": "Search in the book",
				"sidebar/texttospeech": "Text to Speech (Test)",
				"sidebar/texttospeech/play": "Play",
				"sidebar/texttospeech/pause": "Pause",
				"sidebar/texttospeech/stop": "Stop",
			...
			tc: {
				...
				"toolbar/zoom-in": "放大",
				"toolbar/zoom-out": "縮小",
				"toolbar/flow/paginated": "翻頁模式: 左右翻頁",
				"toolbar/flow/scrolled": "翻頁模式: 上下滑動",
				"toolbar/spread/none": "左右翻頁: 單頁",
				"toolbar/spread/auto": "左右翻頁: 雙頁",
				"toolbar/search": "搜索內文",
				...
				"sidebar/texttospeech": "文字轉語音 (測試)",
				"sidebar/texttospeech/play": "播放",
				"sidebar/texttospeech/pause": "暫停",
				"sidebar/texttospeech/stop": "停止",
				"sidebar/settings": "設置",
			...
			sc: {
				...
				"toolbar/zoom-in": "放大",
				"toolbar/zoom-out": "缩小",
				"toolbar/flow/paginated": "翻页模式: 左右翻页",
				"toolbar/flow/scrolled": "翻页模式: 上下滑动",
				"toolbar/spread/none": "左右翻页: 单页",
				"toolbar/spread/auto": "左右翻页: 双页",
				"toolbar/search": "搜索內文",
				"toolbar/cancelsearch": "取消搜索",
				...
				"sidebar/search": "搜索內文",
				"sidebar/search/placeholder": "搜索內文",
				"sidebar/texttospeech": "文字转语音 (测试)",
				"sidebar/texttospeech/play": "播放",
				"sidebar/texttospeech/pause": "暂停",
				"sidebar/texttospeech/stop": "停止",
				"sidebar/settings": "设置",
